...
(function() {
  $(document).ready(function() {
    return $("#home-search-button").click(function() {
      return window.location = "/id/" + ($("#home-search-field").val());
    });
  });
...
(function() {
  $(document).ready(function() {
    return $(".btn-success, .btn-warning, .btn-danger").click(function(event) {
      ...
      return $(event.target).parents(".panel").toggleClass("panel-danger", $(event.target).hasClass("btn-danger"));
    });
  });
